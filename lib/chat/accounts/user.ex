...
def validate_username(changeset, _opts) do
  ...
  |> validate_format(:username, ~r/^[a-zA_A0-9_-]+$/, message: "must have only letters and digits")
  |> validate_length(:username, max: 16, min: 3)
  ...
  defp validate_email(changeset, opts) do
    ...
    |> validate_exclusion(:email, ~w(admin system root friend))
